...
var isTruthy = function(oneArg) {
    return oneArg ? true : false;
};
...
if( totalPessoas > carro.assentos ) {
    ...
    var pluralOuSingular = quantasPessasCabem === 1 ? ' pessoa' : ' pessoas';
    var pluralOuSingular2 = quantasPessasCabem === 1 ? 'cabe' : 'cabem';
    return 'Só '+pluralOuSingular2+' mais '+quantasPessasCabem + pluralOuSingular +'!';
}
